...
export default function SignupPage() {
  ...
  const onSubmit = (data: SignupForm) => {
    const { confirm_password, terms_accepted, ...signupData } = data;
    signUp.mutate({
      ...signupData,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-neutral-light flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-neutral-dark">Winbro Training</span>
          </Link>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.company_name && (
                  <p className="text-sm text-danger">{errors.company_name.message}</p>
                )}
              </div>
              ...
              {errors.terms_accepted && (
                <p className="text-sm text-danger">{errors.terms_accepted.message}</p>
              )}
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background px-2 text-neutral-mid">Or continue with</span>
                </div>
              </div>
